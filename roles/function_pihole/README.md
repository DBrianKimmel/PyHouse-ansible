# Role Name: function_pihole

Install Pi-Hole 
Pi-Hole is a dns resolver thet is used to block ads, tracers and other undesireable sites.

Just install it and then point any device you want to protect to use the pi-hole server as the upstream dns server.

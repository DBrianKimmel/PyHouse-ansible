# Role Name: setup_house_proxy

This role sets up a reverse proxy machine with all the links for a house.
...
This roll will invoke the PyHouse-ansible role 'install_nginx'.
...
This role was created by D. Brian Kimmel on Nov 09, 2020